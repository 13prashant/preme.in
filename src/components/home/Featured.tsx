      ...
      <div className="preme-container flex flex-col gap-5 md:flex-row justify-center items-center duration-300">
        ...
        <div>
          <div className="relative w-fit">
            <h1 className="relative text-xl md:text-2xl font-semibold z-20 duration-300">
              Best Independent Lyricist
            </h1>
            <BottomBorder className="-mt-2 z-10" />
          </div>
          <h6 className="relative text-gray-700 md:text-xl z-20 duration-300">
